...
# execute if score kill_tnt claims.config matches 1 run function claims:marker/kill_tnt with storage claims:main

# execute if score disable_creepers claims.config matches 1 run function claims:marker/disable_creepers with storage claims:main