...
execute if score shape claims.settings matches 1 run tellraw @s [{"text":"- Claim Shape: ","color":"gray"},{"text":"Radius","color":"green"},{"text": " - ","color":"gray"},{"text":"Square","color":"gray","clickEvent":{"action":"run_command","value":"/function claims:settings/shape/square"}}]
execute if score shape claims.settings matches 0 run tellraw @s [{"text":"- Claim Shape: ","color":"gray"},{"text":"Radius","color":"gray","clickEvent":{"action":"run_command","value":"/function claims:settings/shape/radius"}},{"text": " - ","color":"gray"},{"text":"Square","color":"green"}]
