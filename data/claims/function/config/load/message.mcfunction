...
data modify storage claims:main message_claim_join_own_color set value "gray"

data modify storage claims:main message_claim_join_invited_text set value "Joined invited claim."
data modify storage claims:main message_claim_join_invited_color set value "gray"

data modify storage claims:main message_claim_join_other_text set value "Joined a claim."
...
data modify storage claims:main message_claim_leave_invited_text set value "Leaved invited claim."
data modify storage claims:main message_claim_leave_invited_color set value "gray"
