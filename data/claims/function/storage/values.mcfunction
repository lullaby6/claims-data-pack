...
scoreboard players operation double_minus_one claims.config *= 2 utils.const
scoreboard players operation double_minus_one claims.config -= 1 utils.const
...
scoreboard players operation quadruple_minus_one claims.config *= 4 utils.const
scoreboard players operation quadruple_minus_one claims.config -= 1 utils.const
