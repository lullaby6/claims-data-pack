...
execute store result score @s claims.player.claim.invite run function claims:claim/invite/check/exist with storage claims:invite data
execute if score @s claims.player.claim.invite matches 1 run return run function claims:claim/invite/cancel/not_exist

execute store result score @s claims.player.claim.invite run function claims:claim/invite/check/already with storage claims:invite data
execute if score @s claims.player.claim.invite matches 1 run return run function claims:claim/invite/cancel/already_invited
